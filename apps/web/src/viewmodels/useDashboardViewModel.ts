...
export function useDashboardViewModel() {
  ...
  // Query secundaria para el mes de racha detallado (se puede disparar con la lightbox o precargar)
  const streakMonthsQuery = useQuery<DashboardStreakMonthsApiResponse, Error>({
    queryKey: ["dashboard-streak-months"],
    queryFn: () => apiService.get<DashboardStreakMonthsApiResponse>("/dashboard/streak/months?limit=1"),
  });
  ...
  /**
   * Formatea segundos a horas amigables (ej: "3.5 hrs" o "0.8 hrs")
   */
  ...
  /**
   * Formatea segundos a minutos amigables (ej: "45 min" o "1 min")
   */
  ...
  /**
   * Formatea segundos de forma inteligente: minutos si < 1 hora, horas si >= 1 hora
   */
